...
export function saveMultipleResponses(userId: number, responses: Record<string, any>) {
	const db = getDatabase();
	
	// Use a transaction for atomicity
	const saveTransaction = db.transaction((userId: number, responses: Record<string, any>) => {
